...
$('.info-tabs__item').removeClass('info-tab__item--active');
$(this).addClass('info-tab__item--active');

$('.info-tab__content').removeClass('info-tab__content--active');
$($(this).attr('href')).addClass('info-tab__content--active');
